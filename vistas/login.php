...
<body>
    ...
    <main class="homecss">
        <div class="d-flex justify-content-center align-items-center p-3 logincontent">
            <div class="bg-white rounded p-3" style="width: 400px;">
                <div>
                    ...
                    <div>
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id='usuario' name='usuario' placeholder="usuario" aria-label="Username" aria-describedby="basic-addon1" autofocus>
                        </div>
                        <div class="input-group mb-3">
                        ...
                        <button class="btn btn-primary w-100" id="enviar">Iniciar sesion</button>
                    </div>
                    <div class="my-2 text-center">
                        <span class="mx-1">Si no tienes cuenta</span>
                        <a href="./registro.php" class="text-decoration-none">Registrate</a>
